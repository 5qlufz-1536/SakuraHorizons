...
public class ModBlocks {
    ...
    public static final Block APRICOT_OAK_FENCE = register("apricot_oak_fence", FenceBlock::new, AbstractBlock.Settings.create().solid().strength(2.0f, 3.0f).sounds(BlockSoundGroup.WOOD).burnable(), true);
