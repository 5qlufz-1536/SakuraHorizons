...
public class BambooSpearEntity extends PersistentProjectileEntity {
    private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(BambooSpearEntity.class, TrackedDataHandlerRegistry.BYTE);
    private boolean dealtDamage;
    public int returnTimer;
    public BambooSpearEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public BambooSpearEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntities.THROWN_BAMBOO_SPEAR, x, y, z, world, stack, stack);
    ...
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItems.TAKEYARI);
    }
